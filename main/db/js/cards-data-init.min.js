...
function onGlobalSheetsChanged(value)
{
    ...
    const lastFourNewsArray = extractForLastNewsData(value);
    const lastNewsCardsArray = [];

    lastFourNewsArray.forEach(item => {
        const card = new LastNewsCard(item);
        lastNewsCardsArray.push(card);
    })
}
